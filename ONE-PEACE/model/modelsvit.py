...
@register_model
def one_piece_g_256(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = OnePeaceViT(bucket_size=16, rp_bias=False, shared_rp_bias=True, **kwargs)
    return model


@register_model
def one_piece_g_384(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = OnePeaceViT(bucket_size=24, rp_bias=False, shared_rp_bias=True, **kwargs)
    return model


@register_model
def one_piece_g_448(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = OnePeaceViT(bucket_size=28, rp_bias=False, shared_rp_bias=True, **kwargs)
    return model


@register_model
def one_piece_g_512(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
if __name__ == '__main__':
    ...
    net = one_piece_g_256(num_classes=5)
