...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'ONE-PEACE training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=4, type=int)
    parser.add_argument('--epochs', default=5, type=int)
    parser.add_argument('--accum_iter', default=1, type=int)

    # Model parameters
    parser.add_argument('--model', default='one_piece_g_256', type=str, metavar='MODEL',
                        help='Name of model to train')
    parser.add_argument('--input-size', default=256,
...
def main(args):
    ...
    if args.finetune:
        if args.finetune.startswith('https'):
            ...
            checkpoint = utils.load_model(args, model, model_without_ddp,
                                          optimizer, loss_scaler, model_ema)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'ONE-PEACE training and evaluation script', parents=[get_args_parser()])
